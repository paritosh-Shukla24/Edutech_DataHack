...
const Dashboard = () => {
  ...
  return (
    <div
      className="relative overflow-hidden w-full min-h-screen text-gray-100 p-8"
      style={blockyTextStyle}
    >
      <video
        src="/src/assets/7897-205237709.mp4"
        autoPlay
        muted
        loop
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {[
            ...
            <div
              key={index}
              className="bg-black bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-2xl p-6 flex flex-col items-center justify-center transition-all duration-300 hover:bg-opacity-20"
            >
          ...
          {/* Main Info Card */}
          <div className="bg-black bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-2xl p-8 col-span-1 md:col-span-2 row-span-2">
            ...
            <div className="grid grid-cols-2 gap-6 mt-6">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center bg-black bg-opacity-25 rounded-xl p-4 transition-all duration-300 hover:bg-opacity-10"
                >
            ...
            <div className="mt-8 flex space-x-4">
              ...
              <button className="bg-black bg-opacity-25 text-white px-6 py-3 rounded-xl flex items-center text-sm font-semibold transition-all duration-300 hover:bg-opacity-20">
          ...
          <div className="bg-black bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-2xl p-6 row-span-2">
            ...
            {[
              {
                ...
                date: "11 Aug",
                review:
                  "The real-time processing capabilities have significantly improved our decision-making process.",
              },
              {
                name: "User B",
                team: "Team Beta",
                date: "28 Jul",
                review:
                  "Intuitive interface and powerful analytics tools. It has streamlined our workflow considerably.",
              },
            ].map((review, index) => (
              <div
                key={index}
                className="mb-4 bg-black bg-opacity-25 rounded-xl p-4 transition-all duration-300 hover:bg-opacity-10"
              >
          ...
          {/* Performance Metrics */}
          <div className="bg-black bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-2xl p-6">
            <h2 className="text-2xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600">
              Performance Metrics
            </h2>
            <div className="space-y-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center justify-between bg-black bg-opacity-25 rounded-xl p-4 transition-all duration-300 hover:bg-opacity-10"
                >
          ...
          {/* Analysis Workflow */}
          <div className="bg-black bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-2xl p-6 col-span-1 md:col-span-2">
            <h2 className="text-2xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600">
              Analysis Workflow
            </h2>
          ...
          <div className="bg-black bg-opacity-25 backdrop-filter backdrop-blur-lg rounded-2xl p-6 col-span-1 md:col-span-3">
            <h2 className="text-2xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600">
              Integration Ecosystem
            </h2>
            <div className="grid grid-cols-4 md:grid-cols-8 gap-4">
              {[
                ...
                <div
                  key={index}
                  className="bg-black bg-opacity-30 rounded-xl p-3 text-center transition-all duration-300 hover:bg-opacity-10"
                >
          ...
          {/* External Resources */}
          <div className="bg-black bg-opacity-25 backdrop-filter backdrop-blur-lg rounded-2xl p-6 col-span-1 md:col-span-2">
            <h2 className="text-2xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600">
              External Resources
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center bg-black bg-opacity-30 rounded-xl p-4 transition-all duration-300 hover:bg-opacity-10"
                >
